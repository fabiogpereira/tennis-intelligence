...
- Engineering quality gate: the initial foundation and parser v0.2 milestones passed their checks; the stability pilot receives a fresh gate before publication.
