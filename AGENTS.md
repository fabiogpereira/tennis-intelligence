...
## Current phase
Phase 1 is complete and Phase 2 MCP data-foundation work is active. Research #01 is Tennis DNA; the original pressure work is preserved as Research #02. Parser v0.2 and the serve reconciliation nominate serve-only candidates for stability testing, not publication. Do not implement a Tennis DNA vector, similarity model, PPI, or the final application until feature-specific coverage, context, and stability questions have been reviewed. Record significant disagreements and methodology changes in the relevant document or an ADR.
